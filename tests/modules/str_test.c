...
static char *test_str_convert(void) {
    StrTestCase tests[] = {
        {.name = "parse_int valid positive",
         .src = "(import str [\"parse_int\"]) (parse_int \"42\")",
         .expected_str = "42",
         .expected_type = EXPECT_INT},
        {.name = "parse_int valid negative",
         .src = "(import str [\"parse_int\"]) (parse_int \"-10\")",
         .expected_str = "-10",
         .expected_type = EXPECT_INT},
        {.name = "parse_int zero",
         .src = "(import str [\"parse_int\"]) (parse_int \"0\")",
         .expected_str = "0",
         .expected_type = EXPECT_INT},
        {.name = "parse_int invalid string",
         .src = "(import str [\"parse_int\"]) (parse_int \"abc\")",
         .expected_str = "parse_int: invalid integer",
         .expected_type = EXPECT_ERROR},
        {.name = "parse_int empty string",
         .src = "(import str [\"parse_int\"]) (parse_int \"\")",
         .expected_str = "parse_int: empty string",
         .expected_type = EXPECT_ERROR},
        {.name = "parse_int trailing garbage",
         .src = "(import str [\"parse_int\"]) (parse_int \"42abc\")",
         .expected_str = "parse_int: invalid integer",
         .expected_type = EXPECT_ERROR},
        {.name = "parse_real valid float",
         .src = "(import str [\"parse_real\"]) (parse_real \"1.5\")",
         .expected_str = "1.5",
         .expected_type = EXPECT_REAL},
        {.name = "parse_real integer string",
         .src = "(import str [\"parse_real\"]) (parse_real \"42\")",
         .expected_str = "42",
         .expected_type = EXPECT_REAL},
        {.name = "parse_real negative",
         .src = "(import str [\"parse_real\"]) (parse_real \"-0.5\")",
         .expected_str = "-0.5",
         .expected_type = EXPECT_REAL},
        {.name = "parse_real invalid string",
         .src = "(import str [\"parse_real\"]) (parse_real \"abc\")",
         .expected_str = "parse_real: invalid real",
         .expected_type = EXPECT_ERROR},
        {.name = "parse_real empty string",
         .src = "(import str [\"parse_real\"]) (parse_real \"\")",
         .expected_str = "parse_real: empty string",
         .expected_type = EXPECT_ERROR},
    };
    return run_str_tests(tests, sizeof(tests) / sizeof(tests[0]));
}
