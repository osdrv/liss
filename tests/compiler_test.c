...
static CompilerTestCase compile_tests[] = {
    ...
    },
    {
        ...
        .src = "(and true false)",
        .expected_instructions =
            (uint8_t[]){OP_TRUE, OP_JUMP_IF_FALSE, 0, 1, OP_FALSE, OP_RETURN},
        .expected_instruction_count = 6,
        .expected_constants = NULL,
        .expected_constant_count = 0,
    },
    ...
    },
    {
        ...
        .src = "(or false true)",
        .expected_instructions =
            (uint8_t[]){OP_FALSE, OP_JUMP_IF_FALSE, 0, 3, OP_JUMP, 0, 2, OP_POP,
                        OP_TRUE, OP_RETURN},
        .expected_instruction_count = 10,
        .expected_constants = NULL,
        .expected_constant_count = 0,
    },
    {
        ...
        .expected_instructions = (uint8_t[]){OP_FALSE,
    ...
    },
    {
        ...
        .src = "(cond true 123)",
        .expected_instructions =
            (uint8_t[]){OP_TRUE, OP_JUMP_IF_FALSE, 0, 6, OP_POP, OP_CONSTANT, 0,
                        OP_JUMP, 0, 2, OP_POP, OP_NULL, OP_RETURN},
        .expected_instruction_count = 13,
        .expected_constants = (Value[]){NUMBER_VAL(123.0)},
        .expected_constant_count = 1,
    },
    {
        .name = "compile cond expression with no else resolving to else branch",
        .src = "(cond false 123)",
        .expected_instructions =
            (uint8_t[]){OP_FALSE, OP_JUMP_IF_FALSE, 0, 6, OP_POP, OP_CONSTANT, 0,
                        OP_JUMP, 0, 2, OP_POP, OP_NULL, OP_RETURN},
        .expected_instruction_count = 13,
        .expected_constants = (Value[]){NUMBER_VAL(123.0)},
        .expected_constant_count = 1,
    },
    {
        ...
        .expected_instructions =
            (uint8_t[]){OP_FALSE, OP_JUMP_IF_FALSE, 0, 6, OP_POP, OP_CONSTANT, 0,
                        OP_JUMP, 0, 3, OP_POP, OP_CONSTANT, 1, OP_RETURN},
...
static char* test_compile(void) {
    for (size_t i = 0; i < sizeof(compile_tests) / sizeof(compile_tests[0]);
        ...
        mu_assert("%s: Constant count should match expected count.",
